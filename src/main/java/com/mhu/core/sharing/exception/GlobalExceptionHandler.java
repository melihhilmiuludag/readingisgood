package com.mhu.core.sharing.exception;

import com.mhu.core.sharing.exception.dto.ExceptionResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> unauthorizedHandler(HttpServletRequest req, HttpServletResponse res, Exception e){
        return new ResponseEntity<>(
                ExceptionResponse.builder()
                        .time(LocalDateTime.now())
                        .error(e.getMessage())
